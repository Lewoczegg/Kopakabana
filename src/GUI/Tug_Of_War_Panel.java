...
import Logic.Tournament_Handler_TugOfWar;

public class Tug_Of_War_Panel extends JPanel implements ActionListener{
	...
	int round = 1;
	Tournament_Handler_TugOfWar tournament_handler = new Tournament_Handler_TugOfWar();
