...
import Logic.Tournament_Handler_Volleyball;

public class Volleyball_Panel extends JPanel implements ActionListener{
	...
	int round = 1;
	Tournament_Handler_Volleyball tournament_handler = new Tournament_Handler_Volleyball();
